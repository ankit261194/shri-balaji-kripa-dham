...
/**
 * Generates a complete Material3 Typography configuration dynamically
 * bound to the given FontFamily for the active theme.
 */
...
// Backward-compatible default typography
